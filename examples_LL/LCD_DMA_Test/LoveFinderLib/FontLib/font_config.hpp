...
/* Font_7x10 —— 本工程编译 65 个字符 / 库中 95 个
 *
 * 覆盖测试流程全部文字：状态栏 [n/4] + 环节名、左右分区标签 CPU/DMA、
 * 各环节进度提示、每环节小结（含 SPI 速率 / DMA 开关 / 传输计数）、
 * 以及总汇总表。
 *
 * ⚠️ 数字 0-9 必须全部列出 —— 性能数字是运行时用 snprintf 生成的,
 *    源码里看不到, 漏掉就会显示成空白。 */
#define FONT_7X10_CHARS_STR  " %+,-./0123456789:=ACDEFGHILMNOPRSTUWXY[\\]abcdefghiklmnoprstuvwxz"
#define FONT_7X10_CHARS(X) \
    X(32) X(37) X(43) X(44) X(45) X(46) X(47) X(48) X(49) X(50) X(51)        \
    X(52) X(53) X(54) X(55) X(56) X(57) X(58) X(61) X(65) X(67) X(68)        \
    X(69) X(70) X(71) X(72) X(73) X(76) X(77) X(78) X(79) X(80) X(82)        \
    X(83) X(84) X(85) X(87) X(88) X(89) X(91) X(92) X(93) X(97) X(98)        \
    X(99) X(100) X(101) X(102) X(103) X(104) X(105) X(107) X(108) X(109) X(110) \
    X(111) X(112) X(114) X(115) X(116) X(117) X(118) X(119) X(120) X(122)
